...
# see also http://blog.thinkrelevance.com/2009/7/29/ruby-switcher-working-with-multiple-ruby-versions-has-never-been-this-easy
...
function use_usr_local_ruby_186 {
 export MY_RUBY_HOME=/usr/local
 # export GEM_HOME=$HOME/.gem/ruby/1.8
...
function use_jruby {
 export MY_RUBY_HOME=$HOME/.ruby_versions/jruby-1.3.1
 export GEM_HOME=$HOME/.gem/jruby/1.8
...
function use_jruby_120 {
 export MY_RUBY_HOME=$HOME/.ruby_versions/jruby-1.2.0
 export GEM_HOME=$HOME/.gem/jruby/1.8
 update_path
}
...
function use_ree_186 {
 export MY_RUBY_HOME=$HOME/.ruby_versions/ruby-enterprise-1.8.6-20090610
 export GEM_HOME=$HOME/.gem/ruby/1.8
 update_path
}
...
function use_ruby_191 {
 export MY_RUBY_HOME=$HOME/.ruby_versions/ruby-1.9.1-p129
...
function use_ruby_186 {
 export MY_RUBY_HOME=$HOME/.ruby_versions/ruby-1.8.6-p369
 export GEM_HOME=$HOME/.gem/ruby/1.8
 update_path
}
...
function use_ruby_187 {
 export MY_RUBY_HOME=$HOME/.ruby_versions/ruby-1.8.7-p174
 export GEM_HOME=$HOME/.gem/ruby/1.8
 update_path
}
...
function update_path {
 ...
 export RUBY_VERSION="$(ruby -v | colrm 12)"
